...
## Introduction
In Part 1 we identified what Event Sourcing is and some common use cases. 
...
For the application we'll use **Azure Functions**. To learn more about it check out the links below:
...
## How to Connect Cosmos DB to Azure Function
Using the Cosmos DB feature, **Change Feed**. It's like an RSS feed for the data and it outputs an ordered list of documents. 
Azure Functions have bindings which allows them to listen to the Change Feed.

- [Cosmos DB Trigger](https://.microsoft.com/en-us/azure/azure-functions/functions-create-cosmos-db-triggered-function)
