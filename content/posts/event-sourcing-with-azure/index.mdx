...
## Azure Resources
For the data store we'll use Azure Cosmos DB. To learn more about it check out the links below:
...
Using the Cosmos DB feature, **Change Feed**. It's like an RSS feed for the data and it outputs an ordered list of documents. Azure Functions have bindings which allows them to listen to the Change Feed.
