...
- [Components](#components)
  - [Game Event Api](#game-event-api)
  - [Game Events Datastore](#game-events-datastore)
  - [Top 10 Materialised View](#top-10-materialised-view)
...
## Introduction
In this post we’ll use our knowledge from the previous articles to build a simple Event Sourcing solution. 
...
both in terms of money and computation. In this case of the Top 10 Materialised View we don’t 
see much benefit over instead calling `MAX(10)`on the data, but I believe it is a good demonstration of 
