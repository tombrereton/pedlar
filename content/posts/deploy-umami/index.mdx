...
# Bonus: Custom Domain
You can add a custom domain to your new Umami Admin Website by following the [Custom Domain Certificate Documentation](https://learn.microsoft.com/en-us/azure/container-apps/custom-domains-certificates) for Azure Container Apps.
